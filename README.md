...
* C++: A lightweight C++ front end is available through the [pyprob_cpp](https://github.com/pyprob/pyprob_cpp) library
...
```
git clone git@github.com:pyprob/pyprob.git
cd pyprob
pip install .
```
...
[pyprob/distributions](https://github.com/pyprob/pyprob/tree/master/pyprob/distributions).
...
- `observe_embeddings`: Specifies network structure for observe embedding
  ...
  - `embedding`: Specifies the network type. By default, it is a fully connected
    ...
    refer to
    [pyprob/nn/emdebbing_*.py](https://github.com/pyprob/pyprob/tree/master/pyprob/nn/)
...
The [examples](https://github.com/pyprob/pyprob/tree/master/examples) folder
in this repository provides some working models and inference workflows
as Jupyter notebooks.

A set of continuous integration
[tests](https://github.com/pyprob/pyprob/tree/master/tests) are available in
...
https://github.com/pyprob/pyprob/graphs/contributors
