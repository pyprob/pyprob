...
(defquery uniform-continuous-query [obs]
  (let [uc-min (sample "uc-min" (categorical [[0 1] [100 1] [200 1]]))
...
(def csis-states (take num-particles (infer :csis uniform-continuous-query [9] :tcp-endpoint "tcp://pindarus:6666")))
