...
class Model():
    ...
    def learn_inference_network(self, num_traces, num_traces_end=1e9,
                                ...
                                momentum=0.9, weight_decay=0., save_file_name_prefix=None,
                                save_every_sec=600, pre_generate_layers=True,
                                ...
                                log_file_name=None, lstm_dim=512, lstm_depth=1,
                                proposal_mixture_components=10, sacred_run=None):
