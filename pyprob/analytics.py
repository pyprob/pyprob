from pyprob import PriorInflation, InferenceEngine
...
class Analytics():
    ...
    def prior_statistics(self, num_traces=1000, prior_inflation=PriorInflation.DISABLED, controlled_only=False, *args, **kwargs):
    ...
    def posterior_statistics(self, num_traces=1000, inference_engine=InferenceEngine.IMPORTANCE_SAMPLING, observe=None, controlled_only=False, *args, **kwargs):
