...
class Analytics():
    ...
    def prior_statistics(self, num_traces=1000, prior_inflation=PriorInflation.DISABLED, controlled_only=False, use_address_base=True, bins=100, log_xscale=False, log_yscale=False, n_most_frequent=None, file_name=None, *args, **kwargs):
        trace_dist = self._model.prior_traces(num_traces=num_traces, prior_inflation=prior_inflation, *args, **kwargs)
        return self._collect_statistics(trace_dist, controlled_only, use_address_base, n_most_frequent, file_name, bins, log_xscale, log_yscale)

    def posterior_statistics(self, num_traces=1000, inference_engine=InferenceEngine.IMPORTANCE_SAMPLING, observe=None, controlled_only=False, use_address_base=True, bins=100, log_xscale=False, log_yscale=False, n_most_frequent=None, file_name=None, *args, **kwargs):
    ...
    def trace_distribution_statistics(self, trace_dist, controlled_only=False, use_address_base=True, bins=100, log_xscale=False, log_yscale=False, n_most_frequent=None, file_name=None):
        return self._collect_statistics(trace_dist, controlled_only, use_address_base, n_most_frequent, file_name, bins, log_xscale, log_yscale)

    def _collect_statistics(self, trace_dist, controlled_only, use_address_base, n_most_frequent, file_name, bins, log_xscale, log_yscale):
        if controlled_only:
